...
let s:airline_a_normal   = [ '#00005f' , '#d7ff00' , 17  , 190 ]
let s:airline_b_normal   = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:airline_c_normal   = [ '#9cffd3' , '#15141b' , 85  , 234 ]
...
let s:airline_c_inactive = [ '#9cffd3' , '#15141b' , 85 , 234 , '' ]
...
let s:airline_c_commandline = [ '#9cffd3' , '#15141b' , 85  , 234 ]
